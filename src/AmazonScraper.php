...
use Rismi\Exceptions\AmazonServerException;
use Rismi\Exceptions\CurrencyConversionException;
use Rismi\Exceptions\CurrencyRatesDownloadException;
...
//    ];
    ...
    {
        /// return file_get_contents('C:\\Users\\DongJun\\Downloads\\amz.html');
    ...
    public function extractProductData($dom, $url, $market)
    {
        ...
        $fields = [
            ...
            [
                ...
                'attribute' => "html",
                'callback' => function ($value) {
                    if (false !== preg_match_all('/\{"hiRes":"([^"]+)"/', $value, $matches)) {
                        return array_slice($matches[1], 0, 6);
                    }
            ...
            [
                'name' => 'shipping',
                'selector' => '#ourprice_shippingmessage, .shipping3P', 'attribute' => '_text', //our_price_shipping_message
                'callback' => function ($value) {
                    return $this->clean_price($value);
                }],
            [
                'name' => 'dealshipping', 
                'selector' => '#dealprice_shippingmessage', 'attribute' => '_text', //deal_price_shipping_message
                'callback' => function ($value) {
                    return $this->clean_price($value);
                }],
            [
            ...
            [
                'name' => 'merchant', 
                'selector' => '#merchant-info', 'attribute' => '_text',
                'callback' => function ($value) {
                    return $this->clean_text($value);
                }],
            [
                'name' => 'merchant_url', 
                'selector' => '#merchant-info a', 'attribute' => 'href',
                'callback' => function ($value) {
                    return $this->clean_text($value);
                }],
            [
                'name' => 'olp', 
                'selector' => '[data-feature-name=olp]', 'attribute' => 'html',
            ...
            [
                'name' => 'availability', 
                'selector' => '#availability', 'attribute' => '_text',
                'callback' => function ($value) {return $this->clean_text($value);}],
            [
                'name' => 'holiday_delivery_message', 
                'selector' => '[data-feature-name=holidayDeliveryMessage]', 'attribute' => '_text',
                'callback' => function ($value) {
                    return $this->clean_text($value);
                }],
            [
                'name' => 'dynamic_delivery_message', 
                'selector' => '#ddmDeliveryMessage', 'attribute' => '_text',
                'callback' => function ($value) {
                    return $this->clean_text($value);
                }],
            [
                'name' => 'weight', 
                'selector' => '.shipping-weight .value, #productDetailsTable li:contains("Peso"), #detail_bullets_id li:contains("Peso")', 
                'attribute' => '_text',
                'callback' => function ($value) {
